...
class Users extends \Entity\Users implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function setRole(\Entity\Roles $role)
    {
        $this->__load();
    ...
    public function setUserProfile(\Entity\UserProfiles $userProfile)
    {
        $this->__load();
    ...
    {
        return array('__isInitialized__', 'id', 'username', 'password', 'email', 'activated', 'banned', 'banReason', 'newPasswordKey', 'newPasswordRequested', 'newEmail', 'newEmailKey', 'lastIp', 'lastLogin', 'created', 'modified', 'role', 'userProfile');
    }
